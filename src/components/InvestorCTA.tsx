    ...
    <section className="relative py-24 md:py-32 px-4 overflow-hidden">
      <div className="max-w-4xl mx-auto">
        <div className="glass-glow rounded-2xl p-10 md:p-16 text-center relative overflow-hidden">
          <div className="absolute -top-20 -left-20 w-60 h-60 rounded-full opacity-20 blur-[80px]" style={{ background: '#3b82f6' }} />
          <div className="absolute -bottom-20 -right-20 w-60 h-60 rounded-full opacity-20 blur-[80px]" style={{ background: '#00f0ff' }} />

          <div className="relative">
            <span className="inline-flex items-center gap-2 px-4 py-2 text-[10px] font-bold tracking-[0.4em] uppercase border border-[#3b82f6]/30 text-[#3b82f6] mb-6">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center mb-8">
              <a
                ...
                style={{ background: 'linear-gradient(135deg, #3b82f6, #2563eb)', boxShadow: '0 0 30px rgba(168,85,247,0.4)' }}
              >
                <Mail className="w-4 h-4" />
                {config.cta.buttonText}
              </a>
              <a
                href="https://www.ghoulverse.com/investors?from=googoo"
                target="_blank"
