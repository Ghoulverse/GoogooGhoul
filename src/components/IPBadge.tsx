      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-12">
          ...
          <div className="glass-glow rounded-2xl p-8 relative overflow-hidden">
            <div className="absolute inset-0 opacity-10" style={{ background: 'radial-gradient(circle at top right, #3b82f6, transparent 70%)' }} />
            <div className="relative">
              <div className="flex items-center gap-3 mb-6">
                <div className="w-12 h-12 rounded-xl bg-[#3b82f6]/10 border border-[#3b82f6]/30 flex items-center justify-center">
              ...
              <div className="flex flex-col gap-2">
                {config.ipClasses.map((ipClass) => (
                  <div key={ipClass} className="flex items-center gap-2 text-[#3b82f6] text-xs">
          ...
          <div className="grid grid-cols-1 gap-4">
            {[
              { icon: Lock, title: 'Brand Lockup', desc: 'Logo, name, and character design mapped for trademark protection across target classes.', color: '#3b82f6' },
