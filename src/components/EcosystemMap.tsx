        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-4 mb-12">
          {ALL_GHOULS.map((g) => {
            ...
            return (
              ...
              >
                {isCurrent && (
                  <span className="absolute -top-2 left-1/2 -translate-x-1/2 text-[9px] font-bold tracking-wider uppercase px-2 py-0.5 rounded-full bg-[#3b82f6] text-white">
                    You Are Here
                  </span>
                )}
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-10">
          {[
            ...
            <div key={stat.label} className="glass rounded-xl p-5 text-center">
              <p className="font-mono text-3xl md:text-4xl text-[#3b82f6] mb-1">{stat.value}</p>
