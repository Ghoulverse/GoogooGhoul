    ...
    <section className="relative py-24 md:py-32 px-4" style={{ background: 'linear-gradient(180deg, transparent, rgba(168,85,247,0.03), transparent)' }}>
      <div className="max-w-6xl mx-auto">
        <div className="text-center mb-16">
          <span className="text-[#3b82f6] text-xs font-bold tracking-[0.3em] uppercase mb-3 block">
        ...
        <div className="glass-glow rounded-2xl p-8 md:p-12 text-center mb-12 relative overflow-hidden">
          <div className="absolute inset-0 opacity-10" style={{ background: 'radial-gradient(circle at center, #3b82f6, transparent 70%)' }} />
          ...
          <div className="relative flex flex-wrap justify-center gap-4 text-xs">
            ...
            <span className="px-3 py-1 rounded-full bg-[#00f0ff]/10 border border-[#00f0ff]/30 text-[#3b82f6]">Equity: {config.equityOffered}</span>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-12">
          {config.traction.map((t, i) => {
            ...
            const statusColors = {
              ...
              upcoming: { bg: 'rgba(168,85,247,0.1)', border: 'rgba(168,85,247,0.3)', text: '#3b82f6' },
            };
        ...
        <div className="glass rounded-2xl p-8 mb-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            {config.projectedRevenue.map((rev) => (
              <div key={rev.year} className="rounded-xl p-5 border border-[#3b82f6]/20 bg-[#3b82f6]/5">
        ...
        <div className="text-center">
          <a
            ...
            style={{ background: 'linear-gradient(135deg, #3b82f6, #00f0ff)', boxShadow: '0 0 30px rgba(168,85,247,0.3)' }}
          >
