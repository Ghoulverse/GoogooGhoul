  ...
  theme: {
    extend: {
      ...
      boxShadow: {
        ...
        'glow': '0 0 20px rgba(147, 197, 253, 0.3), 0 0 40px rgba(191, 219, 254, 0.15)',
        'glow-intense': '0 0 30px rgba(147, 197, 253, 0.5), 0 0 60px rgba(191, 219, 254, 0.3)',
      },
      keyframes: {
        "accordion-down": {
          from: { height: "0" },
